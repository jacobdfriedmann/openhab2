...
public class ZWaveConverterHandler {
	 ...
	 */
	public ZWaveConverterHandler(ZWaveController controller) {
	...
	public void executeRefresh(String itemName, boolean forceRefresh) {
/*		ZWaveBindingConfig bindingConfiguration = provider.getZwaveBindingConfig(itemName);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Integer getRefreshInterval(String itemName) {
//		ZWaveBindingConfig bindingConfiguration = provider.getZwaveBindingConfig(itemName);
		ZWaveCommandClass commandClass;
//		String commandClassName = bindingConfiguration.getArguments().get("command");
...
*/
		return 0;//bindingConfiguration.getRefreshInterval();
	}
	 ...
	 */
	public void handleEvent(String itemName, ZWaveCommandClassValueEvent event) {
/*		ZWaveBindingConfig bindingConfiguration = provider.getZwaveBindingConfig(itemName);
